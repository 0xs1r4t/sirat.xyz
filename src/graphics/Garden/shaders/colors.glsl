// Color Palette Library — kept verbatim from fairy-forest-glade / web-terrain.
// The grassy greens (GRASS_*) intentionally stay constant across site themes;
// the theme drives fog, background blending, and DOM chrome instead.
