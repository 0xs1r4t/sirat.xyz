...
/**
 * Renders `render` with live Leva-controlled garden values. Split into its
 * own module so Scene.tsx can load it via next/dynamic — Leva (and its UI
 * bundle) only reaches visitors who are actually in debug mode, instead of
 * shipping to every hero-page load.
 */
