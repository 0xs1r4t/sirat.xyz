/**
 * Heightfield terrain generator — ported verbatim from web-terrain-generator
 * `lib/terrain.ts` (warped fBm + ridged blend, face-normal accumulation).
 * The garden's rectangular plane, grass roots, flower stems, camera height
 * and hover hit-spheres all sample this one data structure.
 */
